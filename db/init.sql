...
CREATE TABLE features (
  ...
  layer VARCHAR(50) NOT NULL CHECK (layer IN ('fuel','food','water','raw_materials','vehicles','roads','bridges','maintenance','hygiene','staging_areas','transshipment','cameras','powerlines','telecom','railways','ports','airports','medical','emergency','tunnels','fording_points')),
